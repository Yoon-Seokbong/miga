...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const headCopyStyle = "font-family: 'GMarketSans', sans-serif; font-size: 40px; font-weight: 900; text-align: center; margin: 80px 20px 10px 20px; word-break: keep-all; line-height: 1.3; color: #333;";
        const subCopyStyle = "font-family: 'Pretendard', sans-serif; font-size: 22.5px; font-weight: 400; text-align: center; color: #333; margin: 0 20px 40px 20px; word-break: keep-all; line-height: 1.6;";
        ...
        const ctaButtonStyle = "background-color: #ff5722; color: white; padding: 20px 40px; border: none; border-radius: 50px; font-size: 24px; font-weight: 700; cursor: pointer; text-decoration: none; display: inline-block;";
