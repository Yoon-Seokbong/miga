  ...
  if (error) return <main className="flex-grow container mx-auto p-8 text-center text-xl mt-8 text-red-500">{error}</main>;
    ...
    return (
      <main className="flex-grow container mx-auto p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8"> {/* Main grid for layout */}
          ...
          <div className="lg:col-span-1">
            <div className="mb-6 p-4 rounded-lg bg-gray-50 dark:bg-gray-800 shadow">
              ...
              {categories.map(parentCategory => (
                <div key={parentCategory.id} className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  <h4 className="text-md font-bold mb-2">{parentCategory.name}</h4>
                  <CategoryTree
          ...
          {/* Right Column: Search, Price Filter, Sort, and Product Grid */}
